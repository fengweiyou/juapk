...
<link rel="stylesheet" type="text/css" href="res/popeye/css/jquery.popeye.css" media="screen" />
<script type="text/javascript" src="res/popeye/js/jquery.popeye-2.1.js"></script>
		...
		<div class="des">
		   <div class="ppy" id="ppy2">
            <ul class="ppy-imglist">
                <li><a href="res/upload/soft/m0.png"><img src="res/upload/soft/1.jpg" /></a></li>
                <li><a href="res/upload/soft/m1.png"><img src="res/upload/soft/2.jpg" /></a></li>
                <li><a href="res/upload/soft/m2.png"><img src="res/upload/soft/3.jpg" /></a></li>
            </ul>
            <div class="ppy-outer">
                <div class="ppy-stage">
